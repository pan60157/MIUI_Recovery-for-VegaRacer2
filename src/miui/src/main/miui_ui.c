...
static int _miui_setbg_title(CANVAS *win, CANVAS *bg) {
  ...
  //draw battery
  _miui_draw_battery(win, agw()/2 + 2*elmP, elmP, acfg()->titlefg, acfg()->titlebg_g);
  //draw time
...
STATUS miui_langmenu(char *title_name, char *title_icon) {
  ...
  //-- Populate Checkbox Items
  acsdmenu_add(menu1, "简体中文", "欢迎使用中文恢复系统 pan60157制作 @anzhi.com", "@lang.cn");
  acsdmenu_add(menu1, "English", "Welcome to MIUI Recovery by pan60157 @anzhi.com", "@lang.en");
